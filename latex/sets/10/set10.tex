...
\begin{document}
\config{name}{Independence, Inclusion Exclusion, Union Bound, Hashing and Bin Packing}
\noindent{\bf Independence, Inclusion Exclusion, Union Bound, Hashing and Bin Packing}.
